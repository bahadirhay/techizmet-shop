...
export const DISTRIBUTION_PLATFORMS: DistributionPlatform[] = [
  ...
  },
  {
    ...
    description: "Yeni/güncel URL'ler anında bildirilir — günlük cron + yayın anında otomatik.",
    automated: true,
    steps: [
      "Anahtar dosyası: /indexnow-key.txt",
      "Günlük tam tarama: Vercel cron 05:30 (TR)",
      "Ürün/blog/koleksiyon yayınında anlık bildirim",
    ],
  },
  {
    id: "sitemap-ping",
    category: "search",
    label: "Sitemap ping (Bing + Yandex)",
    description: "Sitemap güncellendiğinde Bing ve Yandex'e bildirim — otomatik.",
    automated: true,
  },
  {
    id: "rss-feed",
