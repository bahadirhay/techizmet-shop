...
import {
  PRODUCT_MEDIA_ZOOM_FIX_CSS,
  PRODUCT_MEDIA_ZOOM_FIX_SCRIPT,
} from "@/lib/product-media-zoom-fix";
import {
...
export function ensureProductMediaZoomFix(doc: Document) {
...
export function applyProductDetailFromAdmin(
  ...
  // Zoom script postMessage içerir; strip sonrası yeniden ekle
  ensureProductMediaZoomFix(doc);
