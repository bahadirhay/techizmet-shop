export const PRODUCT_IMAGE_CSS = "/theme/techizmet-shop/kn-product-images.css?v=1";
...
export function injectMirrorProductImageStyles(html: string): string {
  if (html.includes("kn-product-images.css")) {
    return html.replace(/kn-product-images\.css\?v=\d+/g, "kn-product-images.css?v=1");
  }
